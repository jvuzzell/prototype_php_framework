...
class Directory_search {
    ...
    Private function scan_directory( string $needle, string $haystack ) {
    ...
    Private function traverse_parent_directories( string $needle, array $search_args ) : array {
    ...
    Private function traverse_children_directories( string $needle, array $search_args ) : array {
    ...
    Private function search_for_file( string $needle, array $search_args ) : array {
    ...
    Private function calculate_search_depth( string $path_to_directory = '' ) : int {
    ...
    Public function search( array $find_these_files = [], array $args = [] ) : array {
    ...
    Private function response_helper( $args = array() ) : array {
